...
ggplot(df, aes(x = precipitacion_mm)) +
  ...
  labs(title = "Distribución de la Precipitación", x = "Precipitación (mm)", y = "Frecuencia")
```
:::
...
A continuación, realizamos un análisis comparativo de las características promedio de cada cluster para describir los perfiles climáticos de cada grupo.

-   Cluster 1: Este cluster muestra un perfil caracterizado por temperaturas moderadas y alta humedad. Las estaciones en este grupo suelen ubicarse en regiones con condiciones climáticas templadas.

-   Cluster 2: Compuesto por estaciones en regiones cálidas y húmedas. Este grupo probablemente representa zonas de clima tropical o subtropical, con altas temperaturas y humedad elevada.

-   Cluster 3: Caracterizado por bajas temperaturas y baja humedad, típico de regiones montañosas o áreas con clima árido.

-   Cluster 4: Este cluster incluye estaciones con alta variabilidad en la humedad y temperatura moderada, posiblemente de áreas cercanas a la costa o de transición entre climas secos y húmedos.

-   Cluster 5: Incluye estaciones con temperaturas elevadas y humedad baja, lo cual es característico de zonas desérticas o regiones con clima seco.
